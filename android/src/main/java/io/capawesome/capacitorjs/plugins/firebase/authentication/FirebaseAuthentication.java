...
public class FirebaseAuthentication {
  ...
  public FirebaseAuthentication(
    FirebaseAuthenticationPlugin plugin,
    FirebaseAuthenticationConfig config
  ) {
    this.plugin = plugin;
    this.config = config;
  ...
  public void createUserWithEmailAndPassword(PluginCall call) {
    ...
    if (skipNativeAuth) {
      call.reject(
        FirebaseAuthenticationPlugin.ERROR_EMAIL_SIGN_IN_SKIP_NATIVE_AUTH
      );
      return;
    }
  ...
  public void confirmVerificationCode(
    @NonNull ConfirmVerificationCodeOptions options,
  ...
  public void getIdToken(
    ...
    if (user == null) {
      resultCallback.error(
        new Exception(FirebaseAuthenticationPlugin.ERROR_NO_USER_SIGNED_IN)
      );
      return;
    }
  ...
  public void linkWithEmailAndPassword(final PluginCall call) {
    ...
    if (skipNativeAuth) {
      call.reject(
        FirebaseAuthenticationPlugin.ERROR_EMAIL_LINK_SKIP_NATIVE_AUTH
      );
      return;
    }
    FirebaseUser user = getCurrentUser();
  ...
  public void linkWithEmailLink(final PluginCall call) {
    ...
    AuthCredential credential = EmailAuthProvider.getCredentialWithLink(
      email,
      emailLink
    );
  ...
  public void linkWithPhoneNumber(
    @NonNull final LinkWithPhoneNumberOptions options
  ) throws Exception {
  ...
  public void signInAnonymously(final PluginCall call) {
    ...
    if (skipNativeAuth) {
      call.reject(
        FirebaseAuthenticationPlugin.ERROR_SIGN_IN_ANONYMOUSLY_SKIP_NATIVE_AUTH
      );
      return;
    }
    firebaseAuthInstance
  ...
  public void signInWithEmailLink(final PluginCall call) {
    ...
    if (skipNativeAuth) {
      call.reject(
        FirebaseAuthenticationPlugin.ERROR_EMAIL_LINK_SIGN_IN_SKIP_NATIVE_AUTH
      );
      return;
    }
  ...
  public void signInWithPhoneNumber(final SignInWithPhoneNumberOptions options)
    throws Exception {
  ...
  public void signInWithCustomToken(final PluginCall call) {
    ...
    if (skipNativeAuth) {
      call.reject(
        FirebaseAuthenticationPlugin.ERROR_CUSTOM_TOKEN_SKIP_NATIVE_AUTH
      );
      return;
    }
    ...
    user
      ...
      .addOnCompleteListener(
        task -> {
          if (task.isSuccessful()) {
            AuthResult authResult = task.getResult();
            JSObject userResult = FirebaseAuthenticationHelper.createUserResult(
              authResult.getUser()
            );
            JSObject result = new JSObject();
            result.put(
              "user",
              (userResult == null ? JSONObject.NULL : userResult)
            );
            call.resolve(result);
          } else {
            Exception exception = task.getException();
  ...
  public void handleGoogleAuthProviderSignInActivityResult(
    @NonNull final PluginCall call,
    @NonNull ActivityResult result
  ) {
    googleAuthProviderHandler.handleOnActivityResult(call, result, false);
  }

  public void handleGoogleAuthProviderLinkActivityResult(
    @NonNull final PluginCall call,
    @NonNull ActivityResult result
  ) {
  ...
  public void handlePlayGamesAuthProviderSignInActivityResult(
    @NonNull final PluginCall call,
    @NonNull ActivityResult result
  ) {
  ...
  public void handlePlayGamesAuthProviderLinkActivityResult(
    @NonNull final PluginCall call,
    @NonNull ActivityResult result
  ) {
  ...
  public void handleOnActivityResult(
    ...
    if (
      requestCode == FacebookAuthProviderHandler.RC_FACEBOOK_AUTH &&
      facebookAuthProviderHandler != null
    ) {
      facebookAuthProviderHandler.handleOnActivityResult(
        requestCode,
        resultCode,
        data
      );
