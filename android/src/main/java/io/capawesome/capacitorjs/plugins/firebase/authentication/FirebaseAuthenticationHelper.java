...
public class FirebaseAuthenticationHelper {
  ...
  public static JSObject createSignInResult(
    ...
    return FirebaseAuthenticationHelper.createSignInResult(
      user,
      credential,
      idToken,
      nonce,
  ...
  public static JSObject createSignInResult(
    ...
    JSObject additionalUserInfoResult = FirebaseAuthenticationHelper.createAdditionalUserInfoResult(
      additionalUserInfo
    );
    ...
    result.put(
      "credential",
      (credentialResult == null ? JSONObject.NULL : credentialResult)
    );
    result.put(
      "additionalUserInfo",
      (
        additionalUserInfoResult == null
          ? JSONObject.NULL
  ...
  public static JSObject createUserResult(@Nullable FirebaseUser user) {
    ...
    result.put(
      "displayName",
      (user.getDisplayName() == null ? JSONObject.NULL : user.getDisplayName())
    );
    result.put(
      "email",
      (user.getEmail() == null ? JSONObject.NULL : user.getEmail())
    );
    result.put("emailVerified", user.isEmailVerified());
    result.put("isAnonymous", user.isAnonymous());
    result.put(
      "metadata",
      FirebaseAuthenticationHelper.createUserMetadataResult(user.getMetadata())
    );
    result.put(
      "phoneNumber",
      (user.getPhoneNumber() == null ? JSONObject.NULL : user.getPhoneNumber())
    );
    result.put(
      "photoUrl",
      (user.getPhotoUrl() == null ? JSONObject.NULL : user.getPhotoUrl())
    );
    result.put(
      "providerData",
      FirebaseAuthenticationHelper.createUserProviderDataResult(
    ...
    result.put(
      "tenantId",
      (user.getTenantId() == null ? JSONObject.NULL : user.getTenantId())
    );
    ...
    if (credential != null) {
      ...
      if (credential instanceof OAuthCredential) {
        String oAuthAccessToken =
          ((OAuthCredential) credential).getAccessToken();
  ...
  @Nullable
  public static JSObject createAdditionalUserInfoResult(
    @Nullable AdditionalUserInfo additionalUserInfo
  ) {
    ...
    if (additionalUserInfo.getProfile() != null) {
      ...
      for (Map.Entry<String, Object> entry : additionalUserInfo
        .getProfile()
        .entrySet()) {
  ...
  private static JSObject createUserMetadataResult(
    @Nullable FirebaseUserMetadata metadata
  ) {
    JSObject result = new JSObject();
    if (metadata == null) {
      return result;
  ...
  private static JSArray createUserProviderDataResult(
    ...
    for (UserInfo userInfo : providerData) {
      ...
      userInfoResult.put(
        "email",
        (userInfo.getEmail() == null ? JSONObject.NULL : userInfo.getEmail())
      );
      userInfoResult.put(
        "phoneNumber",
        (
