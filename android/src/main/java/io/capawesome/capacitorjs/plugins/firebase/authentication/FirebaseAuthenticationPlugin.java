...
@CapacitorPlugin(
  ...
  requestCodes = { FacebookAuthProviderHandler.RC_FACEBOOK_AUTH }
)
public class FirebaseAuthenticationPlugin extends Plugin {

  public static final String TAG = "FirebaseAuthentication";
  public static final String PHONE_VERIFICATION_COMPLETED_EVENT =
    "phoneVerificationCompleted";
  public static final String PHONE_VERIFICATION_FAILED_EVENT =
    "phoneVerificationFailed";
  public static final String PHONE_CODE_SENT_EVENT = "phoneCodeSent";
  public static final String ERROR_PROVIDER_ID_MISSING =
    "providerId must be provided.";
  public static final String ERROR_NO_USER_SIGNED_IN = "No user is signed in.";
  public static final String ERROR_OOB_CODE_MISSING =
    "oobCode must be provided.";
  public static final String ERROR_TENANT_ID_MISSING =
    "tenantId must be provided.";
  public static final String ERROR_EMAIL_MISSING = "email must be provided.";
  public static final String ERROR_NEW_EMAIL_MISSING =
    "newEmail must be provided.";
  public static final String ERROR_EMAIL_LINK_MISSING =
    "emailLink must be provided.";
  public static final String ERROR_ACTION_CODE_SETTINGS_MISSING =
    "actionCodeSettings must be provided.";
  public static final String ERROR_PASSWORD_MISSING =
    "password must be provided.";
  public static final String ERROR_NEW_PASSWORD_MISSING =
    "newPassword must be provided.";
  public static final String ERROR_PHONE_NUMBER_MISSING =
    "phoneNumber must be provided.";
  public static final String ERROR_VERIFICATION_ID_MISSING =
    "verificationId must be provided.";
  public static final String ERROR_VERIFICATION_CODE_MISSING =
    "verificationCode must be provided.";
  ...
  public void confirmPasswordReset(PluginCall call) {
    try {
      ...
      implementation.confirmPasswordReset(
        oobCode,
        newPassword,
        () -> call.resolve()
      );
  ...
  public void confirmVerificationCode(PluginCall call) {
    try {
      ...
      ConfirmVerificationCodeOptions options = new ConfirmVerificationCodeOptions(
        verificationId,
        verificationCode
      );
    ...
    try {
      ...
      implementation.getIdToken(
        ...
        new ResultCallback() {
          ...
          public void error(Exception exception) {
            Logger.error(TAG, exception.getMessage(), exception);
            String code = FirebaseAuthenticationHelper.createErrorCode(
              exception
            );
            call.reject(exception.getMessage(), code);
          }
  ...
  public void isSignInWithEmailLink(PluginCall call) {
    try {
      ...
      result.put(
        ...
        implementation.isSignInWithEmailLink(emailLink)
      );
      call.resolve(result);
    } catch (Exception exception) {
      Logger.error(TAG, exception.getMessage(), exception);
  ...
  public void linkWithPhoneNumber(PluginCall call) {
    try {
      ...
      LinkWithPhoneNumberOptions options = new LinkWithPhoneNumberOptions(
        phoneNumber,
        resendCode,
        timeout
      );
  ...
  public void sendSignInLinkToEmail(PluginCall call) {
    try {
      ...
      if (handleCodeInApp != null) actionCodeSettings.setHandleCodeInApp(
        handleCodeInApp
      );

      JSObject iOS = settings.getJSObject("iOS");
      if (iOS != null) actionCodeSettings.setIOSBundleId(
        iOS.getString("bundleId")
      );
      ...
      if (dynamicLinkDomain != null) actionCodeSettings.setDynamicLinkDomain(
        dynamicLinkDomain
      );

      implementation.sendSignInLinkToEmail(
        email,
  ...
  public void signInWithPhoneNumber(PluginCall call) {
    try {
      boolean skipNativeAuth = call.getBoolean(
        "skipNativeAuth",
        this.config.getSkipNativeAuth()
      );
      String phoneNumber = call.getString("phoneNumber");
      if (phoneNumber == null) {
        call.reject(ERROR_PHONE_NUMBER_MISSING);
      ...
      boolean resendCode = call.getBoolean("resendCode", false);
      Long timeout = call.getLong("timeout", 60L);
      SignInWithPhoneNumberOptions options = new SignInWithPhoneNumberOptions(
        skipNativeAuth,
        phoneNumber,
        resendCode,
        timeout
  ...
  public void updateEmail(PluginCall call) {
    try {
      ...
      implementation.updateEmail(user, newEmail, call);
    } catch (Exception exception) {
      Logger.error(TAG, exception.getMessage(), exception);
      String code = FirebaseAuthenticationHelper.createErrorCode(exception);
      call.reject(exception.getMessage(), code);
  ...
  public void handlePhoneVerificationCompleted(
    @NonNull final PhoneVerificationCompletedEvent event
  ) {
    notifyListeners(
      PHONE_VERIFICATION_COMPLETED_EVENT,
      event.toJSObject(),
      true
    );
  }
  ...
  @ActivityCallback
  private void handleGoogleAuthProviderSignInActivityResult(
    @Nullable PluginCall call,
    @Nullable ActivityResult result
  ) {
  ...
  @ActivityCallback
  private void handleGoogleAuthProviderLinkActivityResult(
    @Nullable PluginCall call,
    @Nullable ActivityResult result
  ) {
    if (call == null || result == null) {
  ...
  @ActivityCallback
  private void handlePlayGamesAuthProviderSignInActivityResult(
    @Nullable PluginCall call,
    @Nullable ActivityResult result
  ) {
    if (call == null || result == null) {
    ...
    implementation.handlePlayGamesAuthProviderSignInActivityResult(
      call,
      result
    );
  }
  ...
  @ActivityCallback
  private void handlePlayGamesAuthProviderLinkActivityResult(
    @Nullable PluginCall call,
    @Nullable ActivityResult result
  ) {
    if (call == null || result == null) {
  ...
  private FirebaseAuthenticationConfig getFirebaseAuthenticationConfig() {
    ...
    boolean skipNativeAuth = getConfig()
      .getBoolean("skipNativeAuth", config.getSkipNativeAuth());
    config.setSkipNativeAuth(skipNativeAuth);
    String[] providers = getConfig()
      .getArray("providers", config.getProviders());
