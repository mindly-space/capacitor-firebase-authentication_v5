...
public class OAuthProviderHandler {
  ...
  public void signIn(PluginCall call, String providerId) {
    ...
    Task<AuthResult> pendingResultTask = pluginImplementation
  ...
  private void finishActivityForSignIn(
    final PluginCall call,
  ...
  private void startActivityForLink(
    final PluginCall call,
    OAuthProvider.Builder provider
  ) {
    pluginImplementation
  ...
  private void finishActivityForLink(
    final PluginCall call,
    Task<AuthResult> pendingResultTask
  ) {
    pendingResultTask
    ...
    if (customParameters != null) {
      try {
        ...
        for (int i = 0; i < customParametersList.size(); i++) {
          JSObject customParameter = JSObject.fromJSONObject(
            (JSONObject) customParametersList.get(i)
          );
