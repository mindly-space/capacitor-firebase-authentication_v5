...
public class PhoneAuthProviderHandler {
  ...
  public void signIn(@NonNull final SignInWithPhoneNumberOptions options)
    throws Exception {
  ...
  public void link(@NonNull final LinkWithPhoneNumberOptions options)
    throws Exception {
  ...
  public void confirmVerificationCode(
    ...
    PhoneAuthCredential credential = PhoneAuthProvider.getCredential(
      options.getVerificationId(),
      options.getVerificationCode()
    );
    if (signInOnConfirm) {
      pluginImplementation.signInWithCredential(
        new SignInOptions(skipNativeAuthOnConfirm),
        credential,
        callback
      );
    } else {
  ...
  private void verifyPhoneNumber(
    @NonNull SignInWithPhoneNumberOptions options,
    boolean isLink
  ) throws Exception {
    ...
    if (options.getResendCode()) {
      if (forceResendingToken == null) {
        throw new Exception(
          FirebaseAuthenticationPlugin.ERROR_PHONE_RESEND_TOKEN_MISSING
        );
      }
