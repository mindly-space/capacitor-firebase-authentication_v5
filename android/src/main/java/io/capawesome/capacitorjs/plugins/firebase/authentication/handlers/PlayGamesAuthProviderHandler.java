...
public class PlayGamesAuthProviderHandler {
  ...
  public PlayGamesAuthProviderHandler(
    FirebaseAuthentication pluginImplementation
  ) {
  ...
  public void signIn(PluginCall call) {
    ...
    pluginImplementation.startActivityForResult(
      call,
      signInIntent,
      "handlePlayGamesAuthProviderSignInActivityResult"
    );
  }
  ...
  public void link(PluginCall call) {
    ...
    pluginImplementation.startActivityForResult(
      call,
      signInIntent,
      "handlePlayGamesAuthProviderLinkActivityResult"
    );
  }
  ...
  public void handleOnActivityResult(
    ...
    try {
      ...
      AuthCredential credential = PlayGamesAuthProvider.getCredential(
        serverAuthCode
      );
      String idToken = account.getIdToken();
      if (isLink) {
        pluginImplementation.handleSuccessfulLink(
          call,
          credential,
          idToken,
          null,
        ...
        pluginImplementation.handleSuccessfulSignIn(
          call,
          credential,
          idToken,
          null,
  ...
  private GoogleSignInClient buildGoogleSignInClient(
    @Nullable final PluginCall call
  ) {
        ...
        try {
          ...
          for (String scope : scopeList) {
            googleSignInOptionsBuilder =
              googleSignInOptionsBuilder.requestScopes(new Scope(scope));
          }
        } catch (JSONException exception) {
          Log.e(
            FirebaseAuthenticationPlugin.TAG,
            "buildGoogleSignInClient failed.",
            exception
          );
        }
      }
